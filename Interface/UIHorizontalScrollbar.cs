...
namespace ZZLocalizationMod.UIElements
{
	public class UIHorizontalScrollbar : UIElement
	{
		...
		public UIHorizontalScrollbar()
		{
			...
			this._texture = ZZLocalizationMod.Instance.GetTexture("Interface/ScrollbarHorizontal"); //TextureManager.Load("Images/UI/Scrollbar");
			this._innerTexture = ZZLocalizationMod.Instance.GetTexture("Interface/ScrollbarInnerHorizontal"); //TextureManager.Load("Images/UI/ScrollbarInner");
			this.PaddingLeft = 5f;
